...
import { canParseOperationalLossReport, parseOperationalLossReportFile } from './loss-operational-parser';
...
export function parseOperationalExcelFileV2(input: ExcelFileInput): ParsedExcelImport | null {
  ...
  if (canParseOperationalLossReport(input)) return parseOperationalLossReportFile(input);
